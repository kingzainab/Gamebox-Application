...
//        }
//
//        ImageView favouriteStartIcon = convertView.findViewById(R.id.favourite_star);
//        ImageView favouriteStartIconFilled = convertView.findViewById(R.id.favourite_star_filled);
//
//        // Initially show the unfilled star and hide the filled one
//        favouriteStartIcon.setVisibility(View.VISIBLE);
//        favouriteStartIconFilled.setVisibility(View.GONE);
//
//        favouriteStartIcon.setOnClickListener(v -> {
//            favouriteStartIcon.setVisibility(View.GONE);
//            favouriteStartIconFilled.setVisibility(View.VISIBLE);
//        });
//
//        favouriteStartIconFilled.setOnClickListener(v -> {
//            favouriteStartIconFilled.setVisibility(View.GONE);
//            favouriteStartIcon.setVisibility(View.VISIBLE);
//        });
//
